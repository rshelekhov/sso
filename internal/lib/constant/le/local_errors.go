...
const (
	...
	ErrUserAgentIsRequired                     LocalError = "user_agent is required"
	...
	ErrConfirmChangePasswordEndpointIsRequired LocalError = "confirm_change_password_endpoint is required"
	ErrResetPasswordTokenIsRequired            LocalError = "reset_password_token is required"
	...
	ErrInvalidTokenDataType  LocalError = "invalid token data type"
	...
	ErrFailedToGenerateResetPasswordToken LocalError = "failed to generate email verification token"
	ErrFailedToCreateResetPasswordToken   LocalError = "failed to create reset password token"
	ErrFailedToSendResetPasswordEmail     LocalError = "failed to send reset password email"
