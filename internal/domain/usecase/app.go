...
func (u *Usecase) RegisterApp(ctx context.Context, appName string) error {
	const method = "usecase.Usecase.RegisterApp"
...
func (u *Usecase) generateAndHashSecret(name string) (string, error) {
	const method = "usecase.Usecase.generateAndHashSecret"
...
func (u *Usecase) DeleteApp(ctx context.Context, appID, secretHash string) error {
	const method = "usecase.Usecase.RegisterApp"
