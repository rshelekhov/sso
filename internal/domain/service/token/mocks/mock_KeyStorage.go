...
// GetPrivateKey provides a mock function with given fields: clientID
func (_m *KeyStorage) GetPrivateKey(clientID string) ([]byte, error) {
...
//   - clientID string
func (_e *KeyStorage_Expecter) GetPrivateKey(clientID interface{}) *KeyStorage_GetPrivateKey_Call {
	return &KeyStorage_GetPrivateKey_Call{Call: _e.mock.On("GetPrivateKey", clientID)}
}

func (_c *KeyStorage_GetPrivateKey_Call) Run(run func(clientID string)) *KeyStorage_GetPrivateKey_Call {
...
// SavePrivateKey provides a mock function with given fields: clientID, privateKeyPEM
func (_m *KeyStorage) SavePrivateKey(clientID string, privateKeyPEM []byte) error {
	ret := _m.Called(clientID, privateKeyPEM)
...
//   - clientID string
//   - privateKeyPEM []byte
func (_e *KeyStorage_Expecter) SavePrivateKey(clientID interface{}, privateKeyPEM interface{}) *KeyStorage_SavePrivateKey_Call {
	return &KeyStorage_SavePrivateKey_Call{Call: _e.mock.On("SavePrivateKey", clientID, privateKeyPEM)}
}

func (_c *KeyStorage_SavePrivateKey_Call) Run(run func(clientID string, privateKeyPEM []byte)) *KeyStorage_SavePrivateKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
